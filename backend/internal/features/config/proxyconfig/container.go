...
const (
	ServiceContainer = "proxyConfigService"
	HandlerContainer = "proxyConfigHandler"
)
...
func (m *RouteModule) ConfigureRoutes(router gin.IRouter) error {
	if m == nil {
		return errors.New("proxyconfig module is nil")
	}
	if m.Handler == nil {
		return errors.New("proxyconfig handler is nil")
	}
